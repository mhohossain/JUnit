...
class Assertions_Example1 {
	...
	void test () throws Exception {
		...
		String exp_SuccessMeseage = "Thank you for registering on Demoaut. You may now sign-in using the user name and password you've just entered.";
